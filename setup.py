...
if not SKIP_CUDA_BUILD and not IS_ROCM:
    ...
    if is_sm75:
        ...
        raise NotImplementedError(f"device with compute capability {major}.{minor} not supported.")
    ...
    if is_sm75:
        sources.extend(sm75_sources)
    else:
        sources.extend(sm80_sources)
    ext_modules.append(
        CUDAExtension(
